...
- **Project Name**: `HotelOfferOrchestrator`
- **Generated On**: 2026-09-18 09:49:53 (Asia/Calcutta / GMT+06:30)
...
```
├── 📁 postman/
│   ├── 📄 hotel-orchestrator.postman_collection.json (12.82 KB)
│   └── 📄 README.md (928 B)
├── 📁 src/
│   ├── 📁 activities/
│   │   ├── 📄 cacheActivity.ts (242 B)
│   │   └── 📄 supplierActivities.ts (1.68 KB)
│   ├── 📁 middleware/
│   │   ├── 📄 errorHandler.ts (1.67 KB)
│   │   └── 📄 requestLogger.ts (704 B)
│   ├── 📁 routes/
│   │   ├── 📄 health.route.test.ts (3.12 KB)
│   │   ├── 📄 hotels.route.test.ts (3.27 KB)
│   │   ├── 📄 hotels.ts (4.5 KB)
│   │   ├── 📄 supplierData.ts (2.28 KB)
│   │   ├── 📄 suppliers.route.test.ts (2.75 KB)
│   │   ├── 📄 suppliers.ts (1.43 KB)
│   │   └── 📄 validation.test.ts (1.7 KB)
│   ├── 📁 services/
│   │   ├── 📄 dedupe.test.ts (2.51 KB)
│   │   ├── 📄 dedupe.ts (1.5 KB)
│   │   ├── 📄 redisCache.test.ts (1.74 KB)
│   │   ├── 📄 redisCache.ts (2.65 KB)
│   │   └── 📄 temporalClient.ts (739 B)
│   ├── 📁 types/
│   │   └── 📄 hotel.ts (266 B)
│   ├── 📁 workflows/
│   │   ├── 📄 hotelAggregationWorkflow.test.ts (3.57 KB)
│   │   └── 📄 hotelAggregationWorkflow.ts (2.06 KB)
│   ├── 📄 app.ts (1.49 KB)
│   ├── 📄 config.ts (2.04 KB)
│   ├── 📄 index.ts (706 B)
│   └── 📄 worker.ts (883 B)
├── 📁 test/
│   ├── 📁 integration/
│   │   ├── 📄 health.integration.test.ts (616 B)
│   │   ├── 📄 hotels.integration.test.ts (2.98 KB)
│   │   └── 📄 supplier-outage.integration.test.ts (1.97 KB)
│   └── 📄 setupEnv.ts (358 B)
├── 📄 DesignDocument.md (18.02 KB)
├── 📄 docker-compose.outage.yml (132 B)
├── 📄 docker-compose.yml (2.2 KB)
├── 📄 docker-entrypoint.sh (211 B)
├── 📄 Dockerfile (780 B)
├── 📄 eslint.config.js (592 B)
├── 📄 jest.config.cjs (305 B)
├── 📄 jest.integration.config.cjs (297 B)
├── 📄 package-lock.json (321.8 KB)
...
- [📄 postman/hotel-orchestrator.postman_collection.json](#📄-postman-hotel-orchestrator-postman-collection-json)
- [📄 postman/README.md](#📄-postman-readme-md)
- [📄 src/activities/cacheActivity.ts](#📄-src-activities-cacheactivity-ts)
- [📄 src/activities/supplierActivities.ts](#📄-src-activities-supplieractivities-ts)
...
- [📄 src/routes/health.route.test.ts](#📄-src-routes-health-route-test-ts)
- [📄 src/routes/hotels.route.test.ts](#📄-src-routes-hotels-route-test-ts)
- [📄 src/routes/hotels.ts](#📄-src-routes-hotels-ts)
- [📄 src/routes/supplierData.ts](#📄-src-routes-supplierdata-ts)
- [📄 src/routes/suppliers.route.test.ts](#📄-src-routes-suppliers-route-test-ts)
- [📄 src/routes/suppliers.ts](#📄-src-routes-suppliers-ts)
- [📄 src/routes/validation.test.ts](#📄-src-routes-validation-test-ts)
- [📄 src/services/dedupe.test.ts](#📄-src-services-dedupe-test-ts)
- [📄 src/services/dedupe.ts](#📄-src-services-dedupe-ts)
- [📄 src/services/redisCache.test.ts](#📄-src-services-rediscache-test-ts)
- [📄 src/services/redisCache.ts](#📄-src-services-rediscache-ts)
- [📄 src/services/temporalClient.ts](#📄-src-services-temporalclient-ts)
- [📄 src/types/hotel.ts](#📄-src-types-hotel-ts)
- [📄 src/workflows/hotelAggregationWorkflow.test.ts](#📄-src-workflows-hotelaggregationworkflow-test-ts)
- [📄 src/workflows/hotelAggregationWorkflow.ts](#📄-src-workflows-hotelaggregationworkflow-ts)
- [📄 src/app.ts](#📄-src-app-ts)
- [📄 src/config.ts](#📄-src-config-ts)
- [📄 src/index.ts](#📄-src-index-ts)
- [📄 src/worker.ts](#📄-src-worker-ts)
- [📄 test/integration/health.integration.test.ts](#📄-test-integration-health-integration-test-ts)
- [📄 test/integration/hotels.integration.test.ts](#📄-test-integration-hotels-integration-test-ts)
- [📄 test/integration/supplier-outage.integration.test.ts](#📄-test-integration-supplier-outage-integration-test-ts)
- [📄 test/setupEnv.ts](#📄-test-setupenv-ts)
- [📄 DesignDocument.md](#📄-designdocument-md)
- [📄 docker-compose.outage.yml](#📄-docker-compose-outage-yml)
...
### <a id="📄-postman-hotel-orchestrator-postman-collection-json"></a>📄 `postman/hotel-orchestrator.postman_collection.json`

**File Info:**
- **Size**: 12.82 KB
- **Extension**: `.json`
- **Language**: `json`
- **Location**: `postman/hotel-orchestrator.postman_collection.json`
- **Relative Path**: `postman`
- **Created**: 2026-09-18 09:13:40 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:19:09 (Asia/Calcutta / GMT+06:30)
- **MD5**: `5ec10ef99fccf1d7ba7b90be2de334fd`
- **SHA256**: `20b76659f9a1a3fee877c72be2edfec43fabf62d8c4872dea66a63d260926ccd`
- **Encoding**: ASCII
...
{
  "info": {
    "_postman_id": "b3b6ea2e-39db-4d13-ae1d-4a2c65a0e6e2",
    "name": "Hotel Offer Orchestrator",
    "description": "API checks for the hotel-offer-orchestrator service.",
  ...
  "item": [
    {
      ...
      "item": [
        {
          "name": "Get hotels - Delhi (with overlap)",
          "request": {
            "method": "GET",
            "header": [],
        ...
        {
          "name": "Get hotels - Delhi with price filter",
          "request": {
            "method": "GET",
            "header": [],
            "url": "{{baseUrl}}/api/hotels?city=delhi&minPrice=90&maxPrice=120"
          },
          "event": [
            {
              "listen": "test",
        ...
        {
          "name": "Get hotels - Mumbai",
          "request": {
            "method": "GET",
            "header": [],
            "url": "{{baseUrl}}/api/hotels?city=mumbai"
          },
          "event": [
            {
              "listen": "test",
    ...
    },
    {
      ...
      "item": [
        {
          "name": "Get hotels - unknown city",
          "request": {
            "method": "GET",
            "header": [],
            "url": "{{baseUrl}}/api/hotels?city=atlantis"
          },
          "event": [
            {
              "listen": "test",
              "script": {
                ...
                "exec": [
                  "const body = pm.response.json();",
                  "pm.test('status is 200', function () { pm.response.to.have.status(200); });",
                  "pm.test('response is empty', function () { pm.expect(body).to.be.an('array').that.is.empty; });"
                ]
              }
            }
          ]
    ...
    },
    {
      ...
      "item": [
          ...
          "event": [
            {
              ...
              "script": {
                ...
                "exec": [
                  ...
                  "pm.test('response contains structured error', function () {",
        ...
        {
          "name": "Non-numeric minPrice",
          "request": {
            "method": "GET",
            "header": [],
            "url": "{{baseUrl}}/api/hotels?city=delhi&minPrice=abc"
          },
          "event": [
            {
              "listen": "test",
        ...
        {
          "name": "minPrice greater than maxPrice",
          "request": {
            "method": "GET",
            "header": [],
            "url": "{{baseUrl}}/api/hotels?city=delhi&minPrice=200&maxPrice=100"
          },
          "event": [
            {
              "listen": "test",
          ...
          "event": [
            {
              ...
              "script": {
                ...
                "exec": [
                  "const body = pm.response.json();",
                  "pm.test('status is 200', function () { pm.response.to.have.status(200); });",
                  "pm.test('overall status is ok', function () { pm.expect(body.status).to.equal('ok'); });",
                  "pm.test('both suppliers are up', function () {",
                  "  pm.expect(body.suppliers.supplierA.status).to.equal('up');",
                  "  pm.expect(body.suppliers.supplierB.status).to.equal('up');",
                  "});",
                  "pm.test('Redis and Temporal are up', function () {",
                  "  pm.expect(body.redis.status).to.equal('up');",
                  "  pm.expect(body.temporal.status).to.equal('up');",
                  "});"
                ]
              }
            }
    ...
    {
      "name": "Supplier outage simulation",
      "description": "These requests require the api and worker containers to be restarted with SIMULATE_SUPPLIER_DOWN=a set. Run: docker compose -f docker-compose.yml -f docker-compose.outage.yml up -d --build before running this folder. (This applies the documented outage override.) Restore normal operation afterward by restarting with docker compose -f docker-compose.yml up -d --build without that variable.",
      "item": [
        {
          "name": "Direct mock endpoint - Supplier A down (query param)",
          "request": {
            "method": "GET",
            "description": "This works regardless of SIMULATE_SUPPLIER_DOWN and demonstrates the mock endpoint's own query-param toggle.",
            "header": [],
            "url": "{{baseUrl}}/supplierA/hotels?simulateDown=true"
          },
          "event": [
            {
              "listen": "test",
              "script": {
                "type": "text/javascript",
                "exec": [
                  "pm.test('status is 5xx', function () {",
        ...
        {
          "name": "Hotels during real Supplier A outage",
          "request": {
            "method": "GET",
            "description": "Only passes when the stack is running with SIMULATE_SUPPLIER_DOWN=a; see the folder description.",
            "header": [],
            "url": "{{baseUrl}}/api/hotels?city=delhi"
          },
          "event": [
            {
              ...
              "script": {
                ...
                "exec": [
                  "const body = pm.response.json();",
                  "pm.test('status is 200', function () { pm.response.to.have.status(200); });",
                  "pm.test('all returned hotels are from Supplier B', function () {",
                  "  body.forEach((hotel) => pm.expect(hotel.supplier).to.equal('Supplier B'));",
                  "});"
                ]
              }
            }
        ...
        {
          "name": "Health during real Supplier A outage",
          "request": {
            "method": "GET",
            "description": "Only passes when the stack is running with SIMULATE_SUPPLIER_DOWN=a; see the folder description.",
            "header": [],
          ...
          "event": [
            {
              ...
              "script": {
                ...
                "exec": [
                  "const body = pm.response.json();",
                  "pm.test('status is 200', function () { pm.response.to.have.status(200); });",
                  "pm.test('overall status is degraded', function () { pm.expect(body.status).to.equal('degraded'); });",
                  "pm.test('Supplier A is down and Supplier B is up', function () {",
                  "  pm.expect(body.suppliers.supplierA.status).to.equal('down');",
                  "  pm.expect(body.suppliers.supplierB.status).to.equal('up');",
                  "});"
                ]
              }
...
### <a id="📄-postman-readme-md"></a>📄 `postman/README.md`
...
- **Relative Path**: `postman`
- **Created**: 2026-09-18 09:13:43 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:15:15 (Asia/Calcutta / GMT+06:30)
- **MD5**: `bf4ca023de0402d0b33622ed5691acff`
- **SHA256**: `822230a2cd4fcfcde5890ab399c16002ad89e1e0d7ccd3135df1b34efc3157b8`
- **Encoding**: ASCII
...
### <a id="📄-src-activities-cacheactivity-ts"></a>📄 `src/activities/cacheActivity.ts`

**File Info:**
- **Size**: 242 B
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/activities/cacheActivity.ts`
- **Relative Path**: `src/activities`
- **Created**: 2026-09-18 08:14:31 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:18:44 (Asia/Calcutta / GMT+06:30)
- **MD5**: `882e0dfc90423f4c7d121f7a517bb5ee`
- **SHA256**: `345f1ef10b70f5aa715463ff014e0087ae61a797efec763ea7af54b3b6f18d96`
- **Encoding**: ASCII
...
### <a id="📄-src-activities-supplieractivities-ts"></a>📄 `src/activities/supplierActivities.ts`

**File Info:**
- **Size**: 1.68 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/activities/supplierActivities.ts`
- **Relative Path**: `src/activities`
- **Created**: 2026-09-18 08:14:31 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:18:44 (Asia/Calcutta / GMT+06:30)
- **MD5**: `04910aec0d9a5756577b724f741cefb0`
- **SHA256**: `82b3c94d02ef8a411ebd72e6040969b58fc47627645f8cab098a129762e775d4`
- **Encoding**: ASCII
...
### <a id="📄-src-middleware-errorhandler-ts"></a>📄 `src/middleware/errorHandler.ts`
...
- **Relative Path**: `src/middleware`
- **Created**: 2026-09-18 08:23:01 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:27:46 (Asia/Calcutta / GMT+06:30)
- **MD5**: `85a9858af00f970916770b34662bf4a7`
- **SHA256**: `9321d8a26f5622c317073fe8d76bdc3886c6704fb47cf212ee372b59dbbf3b0b`
- **Encoding**: ASCII
...
### <a id="📄-src-middleware-requestlogger-ts"></a>📄 `src/middleware/requestLogger.ts`
...
- **Created**: 2026-09-18 08:23:01 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:27:46 (Asia/Calcutta / GMT+06:30)
- **MD5**: `d12e0ef983a16d5c181201bf0b48765a`
- **SHA256**: `c6c295c9f99818afaf698073a446f910fc0f21835177505f43dc6a4c277857a5`
- **Encoding**: ASCII
...
### <a id="📄-src-routes-health-route-test-ts"></a>📄 `src/routes/health.route.test.ts`

**File Info:**
- **Size**: 3.12 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/routes/health.route.test.ts`
- **Relative Path**: `src/routes`
- **Created**: 2026-09-18 09:05:11 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:18:23 (Asia/Calcutta / GMT+06:30)
- **MD5**: `d130b971de52599845792f0985c7c665`
- **SHA256**: `953bfe7ae187d7d7920494df0e9c4b0f76b2527ef56eb690301f8c307a77e0d3`
- **Encoding**: ASCII
...
### <a id="📄-src-routes-hotels-route-test-ts"></a>📄 `src/routes/hotels.route.test.ts`

**File Info:**
- **Size**: 3.27 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/routes/hotels.route.test.ts`
- **Relative Path**: `src/routes`
- **Created**: 2026-09-18 09:05:10 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:18:23 (Asia/Calcutta / GMT+06:30)
- **MD5**: `4d7178e61c1418d005c27b03eded3526`
- **SHA256**: `aaef692415591ecba45a12e525537933b7277aa163cb49ccad6b0cb6c1cc48a5`
- **Encoding**: ASCII
...
### <a id="📄-src-routes-hotels-ts"></a>📄 `src/routes/hotels.ts`

**File Info:**
- **Size**: 4.5 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/routes/hotels.ts`
- **Relative Path**: `src/routes`
- **Created**: 2026-09-18 08:19:29 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:05:26 (Asia/Calcutta / GMT+06:30)
- **MD5**: `03b95e985cbb2ece794a2fe23cdc4c3f`
- **SHA256**: `f9215189e2e55c8fce8f3b78786d9fc017cc0aff9dc82f3edddd6069fcad962c`
- **Encoding**: ASCII
...
### <a id="📄-src-routes-supplierdata-ts"></a>📄 `src/routes/supplierData.ts`

**File Info:**
- **Size**: 2.28 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/routes/supplierData.ts`
- **Relative Path**: `src/routes`
- **Created**: 2026-09-18 08:08:37 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:09:13 (Asia/Calcutta / GMT+06:30)
- **MD5**: `78486d0444844287b2483596189ad546`
- **SHA256**: `50c920e4b6511cf82065e368cfd7ff14e28fc6d4dc1d1e8284238374247fed31`
- **Encoding**: ASCII
...
### <a id="📄-src-routes-suppliers-route-test-ts"></a>📄 `src/routes/suppliers.route.test.ts`

**File Info:**
- **Size**: 2.75 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/routes/suppliers.route.test.ts`
- **Relative Path**: `src/routes`
- **Created**: 2026-09-18 09:05:11 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:05:26 (Asia/Calcutta / GMT+06:30)
- **MD5**: `6a9eab24d2600d528e05da93476184b7`
- **SHA256**: `fe0402298037c2d1bfe7ce9bb993df234326ac0397079f26a58e7ae4eb6c60ef`
- **Encoding**: ASCII
...
### <a id="📄-src-routes-suppliers-ts"></a>📄 `src/routes/suppliers.ts`

**File Info:**
- **Size**: 1.43 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/routes/suppliers.ts`
- **Relative Path**: `src/routes`
- **Created**: 2026-09-18 08:08:38 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:05:26 (Asia/Calcutta / GMT+06:30)
- **MD5**: `11f7b5f71db329905720cc3f4e2dc7a9`
- **SHA256**: `fcc2d4570340c113069efc09ea590be5dd1516655a3657e0e1258250def68ea6`
- **Encoding**: ASCII
...
### <a id="📄-src-routes-validation-test-ts"></a>📄 `src/routes/validation.test.ts`

**File Info:**
- **Size**: 1.7 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/routes/validation.test.ts`
- **Relative Path**: `src/routes`
- **Created**: 2026-09-18 09:05:12 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:12:50 (Asia/Calcutta / GMT+06:30)
- **MD5**: `b61bb71d715f2faeeb11fb6b9f8d80a1`
- **SHA256**: `49e8e2eee8b954bd6aa57e7b5883c88ec817f1ef6194f759d3e7a91aee7901aa`
- **Encoding**: ASCII
...
### <a id="📄-src-services-dedupe-test-ts"></a>📄 `src/services/dedupe.test.ts`

**File Info:**
- **Size**: 2.51 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/services/dedupe.test.ts`
- **Relative Path**: `src/services`
- **Created**: 2026-09-18 08:09:43 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:10:34 (Asia/Calcutta / GMT+06:30)
- **MD5**: `d6d56239dd6571eb9bc6d1d5105b4a14`
- **SHA256**: `20d867e12263796cd4e493855a9d6d4bfb56d8e1cdac637fef38d35b8c48d58f`
- **Encoding**: ASCII
...
### <a id="📄-src-services-dedupe-ts"></a>📄 `src/services/dedupe.ts`

**File Info:**
- **Size**: 1.5 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/services/dedupe.ts`
- **Relative Path**: `src/services`
- **Created**: 2026-09-18 08:09:43 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:11:23 (Asia/Calcutta / GMT+06:30)
- **MD5**: `236bc21fb86dee307fec3a1399407b91`
- **SHA256**: `918d3662b03c2dbc5f862d2a119fe6cb161467bb462ced0a234d4e4fe9517d43`
- **Encoding**: ASCII
...
### <a id="📄-src-services-rediscache-test-ts"></a>📄 `src/services/redisCache.test.ts`

**File Info:**
- **Size**: 1.74 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/services/redisCache.test.ts`
- **Relative Path**: `src/services`
- **Created**: 2026-09-18 08:12:05 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:13:12 (Asia/Calcutta / GMT+06:30)
- **MD5**: `441a1e00b3916f01bbf3d72632370fea`
- **SHA256**: `4ffe1ad996d330fa87f286b050a23ed54e9f190d5936e6bcd312b8c2ba847123`
- **Encoding**: ASCII
...
### <a id="📄-src-services-rediscache-ts"></a>📄 `src/services/redisCache.ts`

**File Info:**
- **Size**: 2.65 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/services/redisCache.ts`
- **Relative Path**: `src/services`
- **Created**: 2026-09-18 08:12:05 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:13:12 (Asia/Calcutta / GMT+06:30)
- **MD5**: `af09c092d5960f9e336e87a14270cceb`
- **SHA256**: `0f283547a0547962966f3e5eeeab6d7d788231120e6afc88e480544028e8d505`
- **Encoding**: ASCII
...
### <a id="📄-src-services-temporalclient-ts"></a>📄 `src/services/temporalClient.ts`

**File Info:**
- **Size**: 739 B
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/services/temporalClient.ts`
- **Relative Path**: `src/services`
- **Created**: 2026-09-18 08:19:29 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:22:25 (Asia/Calcutta / GMT+06:30)
- **MD5**: `691e926f8d07b3103305521380758bf9`
- **SHA256**: `49fe77e9e66aa3bd3cdddca8973681c480338cc6a99e42cda15cfa37f3d3c2f7`
- **Encoding**: ASCII
...
### <a id="📄-src-types-hotel-ts"></a>📄 `src/types/hotel.ts`

**File Info:**
- **Size**: 266 B
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/types/hotel.ts`
- **Relative Path**: `src/types`
- **Created**: 2026-09-18 08:06:42 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:10:34 (Asia/Calcutta / GMT+06:30)
- **MD5**: `a9686098afcca9533bb56314a3a78cda`
- **SHA256**: `3703b0d5d04444f0fd109200b8a8ce25f2ce5d1c87a76ae3c569df3cbbe8eb9a`
- **Encoding**: ASCII
...
### <a id="📄-src-workflows-hotelaggregationworkflow-test-ts"></a>📄 `src/workflows/hotelAggregationWorkflow.test.ts`

**File Info:**
- **Size**: 3.57 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/workflows/hotelAggregationWorkflow.test.ts`
- **Relative Path**: `src/workflows`
- **Created**: 2026-09-18 08:14:31 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:18:44 (Asia/Calcutta / GMT+06:30)
- **MD5**: `936456f43bb16ce02fd7aa46231e76b7`
- **SHA256**: `dde362e51ef5e259e298514935b9c3e11d8c249b71e919273ce489aa2d2864f4`
- **Encoding**: ASCII
...
### <a id="📄-src-workflows-hotelaggregationworkflow-ts"></a>📄 `src/workflows/hotelAggregationWorkflow.ts`

**File Info:**
- **Size**: 2.06 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `src/workflows/hotelAggregationWorkflow.ts`
- **Relative Path**: `src/workflows`
- **Created**: 2026-09-18 08:14:31 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:18:44 (Asia/Calcutta / GMT+06:30)
- **MD5**: `ca732e9c28cccc3db1a249dbbab0f7fd`
- **SHA256**: `425b693cc1064117b9b681bd9ed0235b9a57d9997f2856217160ebe5bd151fb9`
- **Encoding**: ASCII
...
- **Created**: 2026-09-18 08:06:42 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:27:46 (Asia/Calcutta / GMT+06:30)
- **MD5**: `5963fa9334b851b11b35c1d29ddea5e3`
- **SHA256**: `19e06d03d43c54353f2ffbbaa1205fac75ed8afb761bb62a7af1d6ab9735ab1d`
- **Encoding**: ASCII
...
### <a id="📄-src-config-ts"></a>📄 `src/config.ts`
...
- **Relative Path**: `src`
- **Created**: 2026-09-18 08:06:42 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:57:56 (Asia/Calcutta / GMT+06:30)
- **MD5**: `cc85680d87e7e45e886d79e068d8f515`
- **SHA256**: `34494c66c9493989dfabbb4558157ba099e43023f018c3406b57939cae5aeeed`
- **Encoding**: ASCII
...
- **Created**: 2026-09-18 08:06:42 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:27:46 (Asia/Calcutta / GMT+06:30)
- **MD5**: `c3a30fe972673efed53cf7514dfc1775`
- **SHA256**: `2e30cd6ffb1507371fd2ded45918a33f74bfe98f6127eaf6ec1bf1b6395c0fbb`
- **Encoding**: ASCII
...
### <a id="📄-src-worker-ts"></a>📄 `src/worker.ts`
...
- **Created**: 2026-09-18 08:14:31 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:27:46 (Asia/Calcutta / GMT+06:30)
- **MD5**: `8db8483dcaee26f5891e73f7d5475766`
- **SHA256**: `d6523cc8ccb1814bb2ffe30b854b40fa3bfed55cd713d76b2b776a409b7b31d3`
- **Encoding**: ASCII
...
### <a id="📄-test-integration-health-integration-test-ts"></a>📄 `test/integration/health.integration.test.ts`

**File Info:**
- **Size**: 616 B
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `test/integration/health.integration.test.ts`
- **Relative Path**: `test/integration`
- **Created**: 2026-09-18 08:56:24 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:57:56 (Asia/Calcutta / GMT+06:30)
- **MD5**: `b98e6a5f72ebe912106b17553091b05f`
- **SHA256**: `86ebd7ab684d6b34192e9bfcf498ceedd180ea9dac2640551b476e98941346c8`
- **Encoding**: ASCII
...
### <a id="📄-test-integration-hotels-integration-test-ts"></a>📄 `test/integration/hotels.integration.test.ts`

**File Info:**
- **Size**: 2.98 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `test/integration/hotels.integration.test.ts`
- **Relative Path**: `test/integration`
- **Created**: 2026-09-18 08:56:24 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:57:56 (Asia/Calcutta / GMT+06:30)
- **MD5**: `fba2de3f3adcda558a3869883c7b3175`
- **SHA256**: `823e12284969f0e1f50084cc6bf0dc80703ea2d261ac20cf29ec5ba585f9f4f3`
- **Encoding**: ASCII
...
### <a id="📄-test-integration-supplier-outage-integration-test-ts"></a>📄 `test/integration/supplier-outage.integration.test.ts`

**File Info:**
- **Size**: 1.97 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `test/integration/supplier-outage.integration.test.ts`
- **Relative Path**: `test/integration`
- **Created**: 2026-09-18 08:56:24 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:18:23 (Asia/Calcutta / GMT+06:30)
- **MD5**: `19109c4e3ef9c5fd9ba11e2bf329b07f`
- **SHA256**: `da51be2bcc34b49fcdba6e5cbe72d34630b859b4e17cec470f3dcc1932cbc42b`
- **Encoding**: ASCII
...
### <a id="📄-test-setupenv-ts"></a>📄 `test/setupEnv.ts`

**File Info:**
- **Size**: 358 B
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `test/setupEnv.ts`
- **Relative Path**: `test`
- **Created**: 2026-09-18 09:05:10 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:07:55 (Asia/Calcutta / GMT+06:30)
- **MD5**: `2b37f73c5176281d3ebf8ca0d36969b2`
- **SHA256**: `fcc5c07b3eb737954e409763899b7f4b0b2fa8480e2a26e0962cca544e8c702d`
- **Encoding**: ASCII
...
process.env.SUPPLIER_A_URL ||= 'http://localhost:3001';
process.env.SUPPLIER_B_URL ||= 'http://localhost:3002';
process.env.PORT ||= '3000';
process.env.CORS_ALLOWED_ORIGINS ||= 'http://localhost:3000';
process.env.SIMULATE_SUPPLIER_DOWN = 'none';

```

---

### <a id="📄-designdocument-md"></a>📄 `DesignDocument.md`

**File Info:**
- **Size**: 18.02 KB
- **Extension**: `.md`
- **Language**: `text`
- **Location**: `DesignDocument.md`
- **Relative Path**: `root`
- **Created**: 2026-09-18 08:05:12 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:05:28 (Asia/Calcutta / GMT+06:30)
- **MD5**: `cd35671bdf39a1b10cf710607d55d3b7`
- **SHA256**: `0e644bf6011a4c0ad53a53bcc9b036d45f832a727e829d03b0e9c26097180388`
- **Encoding**: UTF-8
...
### <a id="📄-docker-compose-outage-yml"></a>📄 `docker-compose.outage.yml`

**File Info:**
- **Size**: 132 B
- **Extension**: `.yml`
- **Language**: `yaml`
- **Location**: `docker-compose.outage.yml`
- **Relative Path**: `root`
- **Created**: 2026-09-18 08:57:36 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:57:56 (Asia/Calcutta / GMT+06:30)
- **MD5**: `25c086d1a649e02cdd8190b4d6e5810b`
- **SHA256**: `16cf22517b4e4fc131981f227e5101094cd5e5cbd9349b7cba5998f819391724`
- **Encoding**: ASCII
...
- **Relative Path**: `root`
- **Created**: 2026-09-18 08:40:02 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:18:23 (Asia/Calcutta / GMT+06:30)
- **MD5**: `68701fcacc6c29d391fc761d9553972e`
- **SHA256**: `898677f17a606a4b82f1c3ee7822e6031a00e8abc492f354203b1f759aac81bf`
- **Encoding**: ASCII
...
services:
  temporal:
    ...
    # The auto-setup wrapper in 1.29.x does not support SQLite persistence; start-dev does via --db-filename.
    # This relies on the auto-setup image also shipping the temporal CLI, which is not part of its contract.
    # Re-verify that binary is present at this path before upgrading the pinned image version.
    entrypoint: ["temporal"]
    command: ["server", "start-dev", "--ip", "0.0.0.0", "--db-filename", "/tmp/temporal.db"]
    environment:
      DB: sqlite
      DBNAME: /tmp/temporal.db
    ports:
      - "7233:7233"
    healthcheck:
  ...
  api:
    ...
    environment:
      ...
      SUPPLIER_A_URL: http://api:3000/supplierA
      SUPPLIER_B_URL: http://api:3000/supplierB
      PORT: 3000
    ...
    restart: on-failure
    healthcheck:
      test: ["CMD-SHELL", "curl --fail --silent http://localhost:3000/health > /dev/null"]
      interval: 10s
      timeout: 5s
      retries: 12
      start_period: 20s
...
### <a id="📄-docker-entrypoint-sh"></a>📄 `docker-entrypoint.sh`
...
- **Relative Path**: `root`
- **Created**: 2026-09-18 08:40:01 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:40:27 (Asia/Calcutta / GMT+06:30)
- **MD5**: `fca27a5dacadcad31d1cabaf3b8b7d67`
- **SHA256**: `c254dc1e6d2419139d0b629a997d2bd69f825fbc7486f9a3158f45bad4383ec3`
- **Encoding**: ASCII
...
- **Relative Path**: `root`
- **Created**: 2026-09-18 08:06:41 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:12:50 (Asia/Calcutta / GMT+06:30)
- **MD5**: `1366c2aa029a2a425c6c86e09e54e101`
- **SHA256**: `502f5dd31248e17c071adfb4b2fee1bd209336a2be75782d9bdf8a4750cdb965`
- **Encoding**: ASCII
...
- **Relative Path**: `root`
- **Created**: 2026-09-18 08:07:00 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:56:50 (Asia/Calcutta / GMT+06:30)
- **MD5**: `15ef7635484ab813e0f80ccd1ec41cb6`
- **SHA256**: `79516faa1b62b62317aa3c8e13dd97bbed84359a939ebcd7ae3914ed8f7e9580`
- **Encoding**: ASCII
...
```json
{
  ...
  "packages": {
    ...
    "node_modules/@jsonjoy.com/fs-core": {
      "version": "4.78.1",
      "resolved": "https://registry.npmjs.org/@jsonjoy.com/fs-core/-/fs-core-4.78.1.tgz",
      "integrity": "sha512-UUGcxEah6eb6PyrF8RDEuVgR0Cs2K6XTiLH7YxNR3DknL3wZCNx1nU5m2Gq5Wq8ipy4uHDay3xt/50KyoTN6Zg==",
      "license": "Apache-2.0",
      "dependencies": {
        "@jsonjoy.com/fs-node-builtins": "4.78.1",
        "@jsonjoy.com/fs-node-utils": "4.78.1",
        "thingies": "^2.5.0"
      },
      "engines": {
        "node": ">=10.0"
    ...
    "node_modules/@jsonjoy.com/fs-fsa": {
      "version": "4.78.1",
      "resolved": "https://registry.npmjs.org/@jsonjoy.com/fs-fsa/-/fs-fsa-4.78.1.tgz",
      "integrity": "sha512-PaoXI4HAELQ/DYxCtqHne7ijrTE0BIEFYXI/qTy4f6pThXiYT5QyJkk96bzpcjdo2D+OM0pUv7mkwffSAl/GSQ==",
      "license": "Apache-2.0",
      "dependencies": {
        "@jsonjoy.com/fs-core": "4.78.1",
        "@jsonjoy.com/fs-node-builtins": "4.78.1",
        "@jsonjoy.com/fs-node-utils": "4.78.1",
        "thingies": "^2.5.0"
      },
    ...
    "node_modules/@jsonjoy.com/fs-node": {
      "version": "4.78.1",
      "resolved": "https://registry.npmjs.org/@jsonjoy.com/fs-node/-/fs-node-4.78.1.tgz",
      "integrity": "sha512-3z6o4qVdKUZTHNXiV+3bKAUkQSD5a2kFwwwag8fe6VvgZ4WNfDbMzWdGvoGx+oRpOcr1iWA9WYwVeVMjSir4mA==",
      "license": "Apache-2.0",
      "dependencies": {
        "@jsonjoy.com/fs-core": "4.78.1",
        "@jsonjoy.com/fs-node-builtins": "4.78.1",
        "@jsonjoy.com/fs-node-utils": "4.78.1",
        "@jsonjoy.com/fs-print": "4.78.1",
        "@jsonjoy.com/fs-snapshot": "4.78.1",
    ...
    "node_modules/@jsonjoy.com/fs-node-builtins": {
      "version": "4.78.1",
      "resolved": "https://registry.npmjs.org/@jsonjoy.com/fs-node-builtins/-/fs-node-builtins-4.78.1.tgz",
      "integrity": "sha512-yaGM1l77yYANFl+w2gdixRZhcQhKodtbI4FZgJg2ApfTTSJcxdYEekU+Ta92sCqSwrOtY+ru4IP81tgJxWXIyA==",
      "license": "Apache-2.0",
      "engines": {
        "node": ">=10.0"
      },
    ...
    "node_modules/@jsonjoy.com/fs-node-to-fsa": {
      "version": "4.78.1",
      "resolved": "https://registry.npmjs.org/@jsonjoy.com/fs-node-to-fsa/-/fs-node-to-fsa-4.78.1.tgz",
      "integrity": "sha512-/Z00TkjLD8zPRimbINaiAQRqpE9HZmiGfxQFMqNcHncmhijS3JsAW21gcNO/16jujoDwXOyEaSSeK+pBtv8QHQ==",
      "license": "Apache-2.0",
      "dependencies": {
        "@jsonjoy.com/fs-fsa": "4.78.1",
        "@jsonjoy.com/fs-node-builtins": "4.78.1",
        "@jsonjoy.com/fs-node-utils": "4.78.1"
      },
      "engines": {
    ...
    "node_modules/@jsonjoy.com/fs-node-utils": {
      "version": "4.78.1",
      "resolved": "https://registry.npmjs.org/@jsonjoy.com/fs-node-utils/-/fs-node-utils-4.78.1.tgz",
      "integrity": "sha512-wm0PVK6XpjHH6GLGVi60+ubD7pNv91KwQ8SBWwn+orRTYdfEIci59/VlOddIGhUSde0t9W9gLNetlPKQHQJsSQ==",
      "license": "Apache-2.0",
      "dependencies": {
        "@jsonjoy.com/fs-node-builtins": "4.78.1",
        "glob-to-regex.js": "^1.3.1"
    ...
    "node_modules/@jsonjoy.com/fs-print": {
      "version": "4.78.1",
      "resolved": "https://registry.npmjs.org/@jsonjoy.com/fs-print/-/fs-print-4.78.1.tgz",
      "integrity": "sha512-NUwSD+BOz0TUpBc+riQpI1G1vOhViSZePeqUPxKznelsk3Iwotu6T/02UAY9WdaGcLdlDX8pllEIyxehnYo9Ng==",
      "license": "Apache-2.0",
      "dependencies": {
        "@jsonjoy.com/fs-node-utils": "4.78.1",
        "tree-dump": "^1.1.0"
    ...
    "node_modules/@jsonjoy.com/fs-snapshot": {
      "version": "4.78.1",
      "resolved": "https://registry.npmjs.org/@jsonjoy.com/fs-snapshot/-/fs-snapshot-4.78.1.tgz",
      "integrity": "sha512-gejpLh45sgYGEHWZP/LP2etxaUOYawDfbFVckl9xDDEvgSAtZf700MzCAGbPBPBzRL+qW5UDDwacIgYXHY3C9Q==",
      "license": "Apache-2.0",
      "dependencies": {
    ...
    "node_modules/@temporalio/activity": {
      "version": "1.24.0",
      "resolved": "https://registry.npmjs.org/@temporalio/activity/-/activity-1.24.0.tgz",
      "integrity": "sha512-eBBho/r9XHe2KczYGzmaSp6e9+6c9ta/GGOBldIBr00D/cV34kJ76iAY3Ue1pQTaP7YaX3phMuOz07uUg/IKyA==",
      "license": "MIT",
      "dependencies": {
    ...
    "node_modules/@temporalio/client": {
      "version": "1.24.0",
      "resolved": "https://registry.npmjs.org/@temporalio/client/-/client-1.24.0.tgz",
      "integrity": "sha512-/GGg6ZYl+pN/bQEvq414CyjDvyM+MM1WsMzi/7SCYb3UlivVXx9nOmH/6BGx8OfYFayp11fkmfSh6rt7vW/ePQ==",
      "license": "MIT",
      "dependencies": {
        "@grpc/grpc-js": "^1.12.4",
        "@temporalio/common": "1.24.0",
        "@temporalio/proto": "1.24.0",
    ...
    "node_modules/@temporalio/common": {
      "version": "1.24.0",
      "resolved": "https://registry.npmjs.org/@temporalio/common/-/common-1.24.0.tgz",
      "integrity": "sha512-jXp77fXwynBcVNc/CaGMT33TVYnhcN26S959HDv7Q71oc0rN6d8RHWR5z0nRCDAu5CQwZQRRhVK0TRdyAiEg7Q==",
      "license": "MIT",
      "dependencies": {
        "@temporalio/proto": "1.24.0",
        "long": "^5.3.2",
    ...
    "node_modules/@temporalio/common/node_modules/protobufjs": {
      "version": "8.8.0",
    ...
    "node_modules/@temporalio/core-bridge": {
      "version": "1.24.0",
      "resolved": "https://registry.npmjs.org/@temporalio/core-bridge/-/core-bridge-1.24.0.tgz",
      "integrity": "sha512-6kzPB8RsHcPU6HDNUSDBFC0JG2UFrV3ThmPmJkeEafKh2DFrKARM8IzxgKeE5MzvdIXYmONFM0UmHg+TZ0/qrQ==",
      "license": "MIT",
      "dependencies": {
        "@grpc/grpc-js": "^1.12.4",
        "@temporalio/common": "1.24.0"
    ...
    "node_modules/@temporalio/nexus": {
      "version": "1.24.0",
      "resolved": "https://registry.npmjs.org/@temporalio/nexus/-/nexus-1.24.0.tgz",
      "integrity": "sha512-SQOQia98KFowgpgH6Cn+7rcpWVEjmJbV5FlqQVQoDH82Q7yl5gT81GO9vN7YRYj5RE2P+DVzEsCc8ohT7Hy57g==",
      "license": "MIT",
      "dependencies": {
        "@temporalio/client": "1.24.0",
        "@temporalio/common": "1.24.0",
    ...
    "node_modules/@temporalio/proto": {
      "version": "1.24.0",
      "resolved": "https://registry.npmjs.org/@temporalio/proto/-/proto-1.24.0.tgz",
      "integrity": "sha512-vhlhB9GpoyJx+78r3lDahHywpdri6LKx7kt7djLIw6XzHyb8FQTIi4lX8DSJBqKp3+HVfL1CLwiqO26KFRzg/g==",
      "license": "MIT",
      "dependencies": {
        "long": "^5.3.2",
        "protobufjs": "^8.7.1"
    ...
    "node_modules/@temporalio/testing": {
      "version": "1.24.0",
      "resolved": "https://registry.npmjs.org/@temporalio/testing/-/testing-1.24.0.tgz",
      "integrity": "sha512-XKCuvgb7smKR3oXy5nDgwYSFX/hmg9zTJ2rZQQsVwJzFkga1TbnWDiuT5YMU0INKjoLhnM6c5YA/uLKlp8sdfg==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
    ...
    "node_modules/@temporalio/worker": {
      "version": "1.24.0",
      "resolved": "https://registry.npmjs.org/@temporalio/worker/-/worker-1.24.0.tgz",
      "integrity": "sha512-Lq79WAHOQFuCFJe1ZJcwcs/u8ZPhHyoTpnWZq1gr6mnB9IRMImAYrJFXY/MY/VdXVltTpy+7T6u/V+P327J+gQ==",
      "license": "MIT",
      "dependencies": {
        "@grpc/grpc-js": "^1.12.4",
        "@swc/core": "^1.3.102",
    ...
    "node_modules/@temporalio/workflow": {
      "version": "1.24.0",
      "resolved": "https://registry.npmjs.org/@temporalio/workflow/-/workflow-1.24.0.tgz",
      "integrity": "sha512-pIA9nxkDCCbBnNuMSffQ44HWHYe3zXFfrDpDLwzh/FUSx8uLbsBM8jwf5oUMf+5eV/qVW9PknZhOu9IFO4XnPA==",
      "license": "MIT",
      "dependencies": {
        "@temporalio/common": "1.24.0",
        "@temporalio/proto": "1.24.0",
    ...
    "node_modules/glob-to-regex.js": {
      "version": "1.3.1",
      "resolved": "https://registry.npmjs.org/glob-to-regex.js/-/glob-to-regex.js-1.3.1.tgz",
      "integrity": "sha512-zhWhMRsgnOym+1txhUmYJGD6eUsbUdrZv55gCYKuJX8t2p3+M8My23PD09bEIsreGUs5pnSa/idmcfp2/IlqGg==",
      "license": "Apache-2.0",
      "engines": {
        "node": ">=10.0"
      },
    ...
    "node_modules/memfs": {
      "version": "4.78.1",
      "resolved": "https://registry.npmjs.org/memfs/-/memfs-4.78.1.tgz",
      "integrity": "sha512-SkSlK6DZbzekBoiu0mcHUx9RRPnsBdaKQ36u8F3HvYZm/lRiD34YabQ2Xr76r+zYENzRPFKBsanAZPSl+r3Nqg==",
      "license": "Apache-2.0",
      "dependencies": {
        "@jsonjoy.com/fs-core": "4.78.1",
        "@jsonjoy.com/fs-fsa": "4.78.1",
        "@jsonjoy.com/fs-node": "4.78.1",
        "@jsonjoy.com/fs-node-builtins": "4.78.1",
        "@jsonjoy.com/fs-node-to-fsa": "4.78.1",
        "@jsonjoy.com/fs-node-utils": "4.78.1",
        "@jsonjoy.com/fs-print": "4.78.1",
        "@jsonjoy.com/fs-snapshot": "4.78.1",
    ...
    "node_modules/minimizer-webpack-plugin": {
      "version": "5.10.1",
      "resolved": "https://registry.npmjs.org/minimizer-webpack-plugin/-/minimizer-webpack-plugin-5.10.1.tgz",
    ...
    "node_modules/nexus-rpc": {
      "version": "0.0.3",
      "resolved": "https://registry.npmjs.org/nexus-rpc/-/nexus-rpc-0.0.3.tgz",
    ...
    "node_modules/schema-utils": {
      "version": "4.5.0",
      "resolved": "https://registry.npmjs.org/schema-utils/-/schema-utils-4.5.0.tgz",
    ...
    "node_modules/webpack": {
      "version": "5.111.0",
      "resolved": "https://registry.npmjs.org/webpack/-/webpack-5.111.0.tgz",
      "integrity": "sha512-A2R74kfE6b3eLKS91iZiol03Ebx7avmJJBOyiP+4LePW9NNeNJGQkKeSQos4dk6R4H0YAMYlv+aOrs1CyWT3eA==",
      "license": "MIT",
      "dependencies": {
        "@types/estree": "^1.0.8",
        "@types/json-schema": "^7.0.15",
...
- **Created**: 2026-09-18 08:06:41 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:57:56 (Asia/Calcutta / GMT+06:30)
- **MD5**: `ebd2400085219a9daf01f4f39f1bf5f7`
- **SHA256**: `614a9a6d05615826ce63636d0d23be61209cd2fc8ca973c6eb7d7e1bb1e571a0`
- **Encoding**: ASCII
...
```json
{
  ...
  "version": "0.1.0",
  "private": true,
  "description": "Skeleton service for orchestrating hotel offers.",
  "main": "dist/index.js",
  "scripts": {
...
- **Location**: `README.md`
- **Relative Path**: `root`
- **Created**: 2026-09-18 09:49:51 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 09:49:53 (Asia/Calcutta / GMT+06:30)
- **MD5**: `adb576ddf2849edba2e2e1716e418a43`
- **SHA256**: `a38017d5aa8134f7c32e3c75bd76867086737db0fd5f53b52c6b0982acf70359`
- **Encoding**: ASCII
...
- **Created**: 2026-09-18 08:06:41 (Asia/Calcutta / GMT+06:30)
- **Modified**: 2026-09-18 08:10:34 (Asia/Calcutta / GMT+06:30)
- **MD5**: `e827f48092d57a6ef05ce1e6455acad1`
- **SHA256**: `c758565f8db6f2bdfc9a174cd6ea47b572bca5b03769cdd4b7b1991a75e59a15`
- **Encoding**: ASCII
